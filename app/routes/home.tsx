        ...
        <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12">
          ...
          <div className="flex-shrink-0 flex flex-col items-center">
            <img
              ...
              alt="Your Avatar"
              className="w-28 h-28 md:w-36 md:h-36 rounded-full border-4 border-blue-500 shadow-lg mb-4 md:mb-0"
              style={{ objectFit: "cover" }}
            />
          </div>
          {/* Content */}
          <div className="flex-1 flex flex-col items-center md:items-start text-center md:text-left gap-4">
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold bg-gradient-to-r from-blue-400 via-purple-500 to-pink-500 bg-clip-text text-transparent">
              Hi, I'm Soksan
            </h1>
            <p className="text-base sm:text-lg md:text-xl text-gray-700 dark:text-gray-300 max-w-xl">
            ...
            <div className="flex flex-col sm:flex-row gap-3 mt-2 w-full sm:w-auto">
              <a
                ...
                className="flex-1 sm:flex-none px-6 py-2 rounded-full bg-blue-600 text-white font-semibold shadow hover:bg-blue-700 transition text-center"
              >
                View Resume
              </a>
              <a
                href="/soksan-portfolio/projects"
                className="flex-1 sm:flex-none px-6 py-2 rounded-full bg-gray-200 dark:bg-gray-800 text-gray-900 dark:text-gray-100 font-semibold shadow hover:bg-gray-300 dark:hover:bg-gray-700 transition text-center"
              >
                View Projects
              </a>
            </div>
