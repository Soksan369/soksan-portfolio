        ...
        <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12">
          ...
          <div className="flex-shrink-0 flex flex-col items-center">
            <img
              ...
              alt="Your Avatar"
              className="w-24 h-24 md:w-32 md:h-32 rounded-full border-4 border-blue-500 shadow-lg mb-4 md:mb-0"
          ...
          <div className="flex-1 flex flex-col items-center md:items-start text-center md:text-left gap-4">
            ...
            <div className="flex flex-col gap-2 text-gray-600 dark:text-gray-400 text-center md:text-left">
              <span>
                <strong>Email:</strong>{" "}
                <a
